...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      console.log('Document upload request:', { id, documentType, notifyCustomer, hasFile: !!req.file });
      ...
      console.log('Order found:', order.orderNumber, 'Customer:', order.customerId.email);
      ...
      await order.save();
      console.log('Order updated with document:', documentType);
      
      // Always send notifications for document uploads (notifyCustomer default to true)
      const shouldNotify = notifyCustomer === 'false' ? false : true;
      ...
      if (shouldNotify) {
        ...
        try {
          ...
          console.log('Sending document upload emails to:', customerData.email, adminEmails);
        ...
        console.log('Not sending notifications - notifyCustomer is false');
      }
